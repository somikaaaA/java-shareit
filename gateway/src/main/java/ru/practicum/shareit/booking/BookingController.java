...
public class BookingController {
    ...
    public ResponseEntity<Object> getBookings(@RequestHeader(X_SHARER_USER_ID) long userId,
        ...
        log.info("Запрос бронирования для пользователя {}, userId={}, from={}, size={}", stateParam, userId, from, size);
    ...
    public ResponseEntity<Object> addApprove(@RequestHeader(X_SHARER_USER_ID) Long userId,
        ...
        log.info("Запрос бронирования {}, для userId={} со статусом подтверждения {}", bookingId, userId, approved);
