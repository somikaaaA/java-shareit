...
public class BookingControllerTest {
    ...
    void setUp() {
        ...
        bookingDto1 = BookingDto.builder()
                .id(1L)
                .start(LocalDateTime.of(2025, 11, 10, 12, 0, 0))
                .end(LocalDateTime.of(2025, 11, 15, 12, 0, 0))
                .itemId(1L)
                .booker(booker)
                .item(item1)
                .build();
        bookingDto2 = BookingDto.builder()
                .id(2L)
                .start(LocalDateTime.of(2025, 12, 12, 12, 0, 0))
                .end(LocalDateTime.of(2025, 12, 17, 12, 0, 0))
                .itemId(2L)
                .booker(booker)
                .item(item2)
                .build();
